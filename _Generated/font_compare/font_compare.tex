...
\setCJKfamilyfont{chiron}[Path=../../_Assets/fonts/fonts/]{ChironSungHK-Text-R.ttf}
\setCJKfamilyfont{huiwen}[Path=../../_Assets/fonts/fonts/]{HuiwenMincho-Improved.ttf}
\setCJKfamilyfont{iming}[Path=../../_Assets/fonts/fonts/]{I.Ming-8.10.ttf}
\setCJKfamilyfont{iansui}[Path=../../_Assets/fonts/fonts/]{Iansui-Regular.ttf}
\setCJKfamilyfont{mizuki}[Path=../../_Assets/fonts/fonts/]{MizukiMing-Regular.ttf}
\setCJKfamilyfont{zhisong}[Path=../../_Assets/fonts/fonts/]{LXGWZhiSongMN.ttf}
\setCJKfamilyfont{chenyu}[Path=../../_Assets/fonts/fonts/]{ChenYuluoyan-2.0-Thin.ttf}
\setCJKfamilyfont{qiji}[Path=../../_Assets/fonts/fonts/]{qiji-combo.ttf}

\setCJKfamilyfont{genryuEL}[Path=../../_Assets/fonts/fonts/]{GenRyuMin2-EL.ttc}
\setCJKfamilyfont{genryuL}[Path=../../_Assets/fonts/fonts/]{GenRyuMin2-L.ttc}
\setCJKfamilyfont{genryuR}[Path=../../_Assets/fonts/fonts/]{GenRyuMin2-R.ttc}
\setCJKfamilyfont{genryuM}[Path=../../_Assets/fonts/fonts/]{GenRyuMin2-M.ttc}
\setCJKfamilyfont{genryuSB}[Path=../../_Assets/fonts/fonts/]{GenRyuMin2-SB.ttc}
\setCJKfamilyfont{genryuB}[Path=../../_Assets/fonts/fonts/]{GenRyuMin2-B.ttc}
\setCJKfamilyfont{genryuH}[Path=../../_Assets/fonts/fonts/]{GenRyuMin2-H.ttc}

\setCJKfamilyfont{genwanEL}[Path=../../_Assets/fonts/fonts/]{GenWanMin2-EL.ttc}
\setCJKfamilyfont{genwanL}[Path=../../_Assets/fonts/fonts/]{GenWanMin2-L.ttc}
\setCJKfamilyfont{genwanR}[Path=../../_Assets/fonts/fonts/]{GenWanMin2-R.ttc}
\setCJKfamilyfont{genwanM}[Path=../../_Assets/fonts/fonts/]{GenWanMin2-M.ttc}
\setCJKfamilyfont{genwanSB}[Path=../../_Assets/fonts/fonts/]{GenWanMin2-SB.ttc}

\setCJKfamilyfont{genyoEL}[Path=../../_Assets/fonts/fonts/]{GenYoMin2-EL.ttc}
\setCJKfamilyfont{genyoL}[Path=../../_Assets/fonts/fonts/]{GenYoMin2-L.ttc}
\setCJKfamilyfont{genyoR}[Path=../../_Assets/fonts/fonts/]{GenYoMin2-R.ttc}
\setCJKfamilyfont{genyoM}[Path=../../_Assets/fonts/fonts/]{GenYoMin2-M.ttc}
\setCJKfamilyfont{genyoSB}[Path=../../_Assets/fonts/fonts/]{GenYoMin2-SB.ttc}
\setCJKfamilyfont{genyoB}[Path=../../_Assets/fonts/fonts/]{GenYoMin2-B.ttc}
\setCJKfamilyfont{genyoH}[Path=../../_Assets/fonts/fonts/]{GenYoMin2-H.ttc}

\setCJKfamilyfont{tsukiji}[Path=../../_Assets/fonts/categories/typewriter-ink/]{huiwen-tsukiji-5-mincho.otf}
\setCJKfamilyfont{oradano}[Path=../../_Assets/fonts/categories/typewriter-ink/]{oradano-mingchao-cc0.ttf}
\setCJKfamilyfont{qijihl}[Path=../../_Assets/fonts/categories/typewriter-ink/]{qiji-huanglingdong.ttf}
\setCJKfamilyfont{taisyo}[Path=../../_Assets/fonts/categories/typewriter-ink/]{taisyo-katsuji-ppoi7.ttf}
\setCJKfamilyfont{kinghwa}[Path=../../_Assets/fonts/categories/typewriter-ink/]{kinghwa-oldson.ttf}
\setCJKfamilyfont{homuraEL}[Path=../../_Assets/fonts/categories/typewriter-ink/]{homura-m-extralight.otf}
\setCJKfamilyfont{homuraL}[Path=../../_Assets/fonts/categories/typewriter-ink/]{homura-m-light.otf}
\setCJKfamilyfont{homuraSL}[Path=../../_Assets/fonts/categories/typewriter-ink/]{homura-m-semilight.otf}
\setCJKfamilyfont{homuraM}[Path=../../_Assets/fonts/categories/typewriter-ink/]{homura-m-medium.otf}
\setCJKfamilyfont{homuraSB}[Path=../../_Assets/fonts/categories/typewriter-ink/]{homura-m-semibold.otf}
\setCJKfamilyfont{homuraB}[Path=../../_Assets/fonts/categories/typewriter-ink/]{homura-m-bold.otf}
\setCJKfamilyfont{homuraH}[Path=../../_Assets/fonts/categories/typewriter-ink/]{homura-m-heavy.otf}
\setCJKfamilyfont{youyou}[Path=../../_Assets/fonts/categories/typewriter-ink/]{youyou-yisong.ttf}
\setCJKfamilyfont{xiangcuiKS}[Path=../../_Assets/fonts/categories/typewriter-ink/]{xiangcui-kesong.ttf}
\setCJKfamilyfont{xiangcuiTW15}[Path=../../_Assets/fonts/categories/typewriter-ink/]{xiangcui-typewriter-w15.ttf}
\setCJKfamilyfont{xiangcuiTW35}[Path=../../_Assets/fonts/categories/typewriter-ink/]{xiangcui-typewriter-w35.ttf}
\setCJKfamilyfont{xiangcuiTW40}[Path=../../_Assets/fonts/categories/typewriter-ink/]{xiangcui-typewriter-w40.ttf}
\setCJKfamilyfont{kangxi}[Path=../../_Assets/fonts/categories/typewriter-ink/]{runzhijia-kangxi.ttf}
\setCJKfamilyfont{xinyugong}[Path=../../_Assets/fonts/categories/typewriter-ink/]{xinyugong-zhengrong.ttf}
\setCJKfamilyfont{maokenFull}[Path=../../_Assets/fonts/categories/typewriter-ink/]{maoken-kangzhong-zusong-full.ttf}
\setCJKfamilyfont{maokenSC}[Path=../../_Assets/fonts/categories/typewriter-ink/]{maoken-kangzhong-zusong-sc.ttf}
\setCJKfamilyfont{tegomin}[Path=../../_Assets/fonts/categories/typewriter-ink/]{new-tegomin-regular.ttf}
\setCJKfamilyfont{hina}[Path=../../_Assets/fonts/categories/typewriter-ink/]{hina-mincho-regular.ttf}
\setCJKfamilyfont{tongwen}[Path=../../_Assets/fonts/categories/typewriter-ink/]{tongwen-zidian.ttf}
\setCJKfamilyfont{huanming}[Path=../../_Assets/fonts/categories/typewriter-ink/]{huan-mingchao.otf}
\setCJKfamilyfont{tekoming}[Path=../../_Assets/fonts/categories/typewriter-ink/]{teko-mincho.ttf}

% ── Latin typewriter font families ───────────────────────────────────────────
\newfontfamily\fEssays[Path=../../_Assets/fonts/categories/typewriter-latin/]{essays1743.ttf}
\newfontfamily\fMystery[Path=../../_Assets/fonts/categories/typewriter-latin/]{mystery-typewriter.ttf}
\newfontfamily\fRoman[Path=../../_Assets/fonts/categories/typewriter-latin/]{roman-antique.ttf}
\newfontfamily\fCarbon[Path=../../_Assets/fonts/categories/typewriter-latin/]{carbon.ttf}
\newfontfamily\fCuomo[Path=../../_Assets/fonts/categories/typewriter-latin/]{cuomotype.otf}
\newfontfamily\fGabriele[Path=../../_Assets/fonts/categories/typewriter-latin/]{gabriele-d.ttf}
\newfontfamily\fHarting[Path=../../_Assets/fonts/categories/typewriter-latin/]{harting-plain.ttf}
\newfontfamily\fHolstein[Path=../../_Assets/fonts/categories/typewriter-latin/]{holstein.ttf}
\newfontfamily\fJackwrite[Path=../../_Assets/fonts/categories/typewriter-latin/]{jackwrite.ttf}
\newfontfamily\fKingthings[Path=../../_Assets/fonts/categories/typewriter-latin/]{kingthings-trypewriter-2.ttf}
\newfontfamily\fMcgarey[Path=../../_Assets/fonts/categories/typewriter-latin/]{mcgarey-regular.ttf}
\newfontfamily\fRadio[Path=../../_Assets/fonts/categories/typewriter-latin/]{radio-newsman.ttf}
\newfontfamily\fSchreibmaschine[Path=../../_Assets/fonts/categories/typewriter-latin/]{schreibmaschine.ttf}
\newfontfamily\fTypeo[Path=../../_Assets/fonts/categories/typewriter-latin/]{typeo.ttf}
\newfontfamily\fVeteran[Path=../../_Assets/fonts/categories/typewriter-latin/]{veteran-typewriter.ttf}
% Page XII: new additions
\newfontfamily\fTTBase[Path=../../_Assets/fonts/categories/typewriter-latin/]{tt2020-base-regular.ttf}
\newfontfamily\fTTStyleB[Path=../../_Assets/fonts/categories/typewriter-latin/]{tt2020-style-b-regular.ttf}
\newfontfamily\fTTStyleD[Path=../../_Assets/fonts/categories/typewriter-latin/]{tt2020-style-d-regular.ttf}
\newfontfamily\fHermes[Path=../../_Assets/fonts/categories/typewriter-latin/]{hermes-ewd.ttf}
\newfontfamily\fSpecialElite[Path=../../_Assets/fonts/categories/typewriter-latin/]{special-elite-regular.ttf}
\newfontfamily\fCutive[Path=../../_Assets/fonts/categories/typewriter-latin/]{cutive-mono-regular.ttf}
% Page XIII: German typewriter fonts (Erika series + Tippa)
\newfontfamily\fErikaOrmig[Path=../../_Assets/fonts/categories/typewriter-latin/]{erika-ormig.ttf}
\newfontfamily\fErikasFarbband[Path=../../_Assets/fonts/categories/typewriter-latin/]{erikas-farbband.ttf}
\newfontfamily\fErikasFarbbandB[Path=../../_Assets/fonts/categories/typewriter-latin/]{erikas-farbband-bold.ttf}
\newfontfamily\fErikasBuero[Path=../../_Assets/fonts/categories/typewriter-latin/]{erikas-buero.ttf}
\newfontfamily\fErikasBueroB[Path=../../_Assets/fonts/categories/typewriter-latin/]{erikas-buero-bold.ttf}
\newfontfamily\fErikaType[Path=../../_Assets/fonts/categories/typewriter-latin/]{erika-type.ttf}
\newfontfamily\fErikaTypeB[Path=../../_Assets/fonts/categories/typewriter-latin/]{erika-type-bold.ttf}
\newfontfamily\fTippa[Path=../../_Assets/fonts/categories/typewriter-latin/]{tippa.ttf}
